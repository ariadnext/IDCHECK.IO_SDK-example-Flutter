    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when {
            isIps -> {
                 ...
                 */
                val dayNightTheme = DayNightTheme(
                    foregroundColor = R.color.idcheckio_sdk_background_color,
                    borderColor = R.color.idcheckio_sdk_border_color,
                    backgroundColor = R.color.idcheckio_sdk_secondary_background_color,
                    primaryColor = R.color.idcheckio_sdk_primary_color,
                ...
                val ipsCustomization = IpsCustomization(theme = dayNightTheme)
